        ...
        >
          {services.map((service, idx) => {
            ...
            return (
              <div
                key={idx}
                className="absolute inset-0 bg-[#2563EB] rounded-[32px] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.15)] flex flex-col border border-white/10 group"
                style={{
              ...
              >
                {/* Clean Image Section - Fully removing the flat 2D spin effect per user backlash */}
                ...
                <div className="h-[45%] w-full bg-[#2563EB] p-8 md:p-10 flex flex-col justify-between z-10 border-t border-white/20">
                  ...
                  <button className="bg-white text-[#2563EB] hover:bg-gray-50 transition-colors w-fit px-6 py-2.5 rounded-full font-bold text-xs flex items-center gap-2 shadow-lg tracking-widest uppercase mt-4">
